namespace _05.TeamworkProjects
{
    internal class Program
    {
        static void Main()
        {
            ...
            List<Team> teamsToDisband = teams.Where(team => team.Members.Count <= 0).ToList();

            List<Team> orderedTeams = validTeams
            ...
            orderedTeams = teamsToDisband.OrderBy(x => x.Name).ToList();
